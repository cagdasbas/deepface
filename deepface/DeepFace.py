...
def find(img_path, db_path, representations=None, model_name ='VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base', silent=False):
	...
	if os.path.isdir(db_path) == True:
		...
		if representations is not None:
			pass
		elif path.exists(db_path+"/"+file_name):
